...
Mikfiles currently worked only Linux. Because it using cron to automatic schedule downloading file. But you can try to download file with mikfiles
...
python3 mikfiles.py
```
Next select menu for downloading files. Here list menu :
<picture>
