...
def main():
    ...
    def AddrInput():
        ip_input = input("""
            [*] Masukkan IP address dengan format dibawah (pisahkan dengan koma untuk IP yang berbeda, gunakan '-' untuk rentang IP, atau '/' untuk subnet):
                |
                v
            192.168.1.1,192.168.10.1-192.168.10.100
                or
            192.168.1.2,192.168.100.0/24
